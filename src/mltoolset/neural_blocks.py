...
def max_pooling2d_layer(
    ...
    """
    TODO(rpeloff) Data format assumed to be "channels last" (i.e. [n_batch, height, width, in_channels])
    NOTE: stride=None uses pool_size as strides
    """
...
def global_pooling2d_layer():
    # Max/Avg. Pooling across entire channel to produce output of shape [1, 1, channels_in]
    # TODO(rpeloff)
    pass
...
def dropout_channel_layer(
    ...
    TL;DR: May improve performance where training set size is small.
...
def convolutional_layers(
        ...
        bn_option_dict=None,  # Additional keyword arg dict of options for tf.layers.batch_normalization
